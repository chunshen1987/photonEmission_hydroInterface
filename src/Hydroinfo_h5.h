...
class HydroinfoH5 {
  private:
    ...
    int Visflag;  // flag to determine whether to read evolutions for viscous
                  // variables
    int Buffersize;
  ...
  public:
    ...
    void addGroupattributeInt(
        hid_t H5groupEventid, string attName, int attValue);
    void addGroupattributeDouble(
    ...
    void CSH5dumpBlockdata(
        hid_t group_id, const hsize_t *dims, string DatasetName,
        double **Dataset);
