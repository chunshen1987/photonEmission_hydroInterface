...
HadronGasRhoSpectralFunction::HadronGasRhoSpectralFunction(std::shared_ptr<ParameterReader> paraRdr_in) : ThermalPhoton{paraRdr_in} {}
...
void HadronGasRhoSpectralFunction::analyticRates(
    ...
    for (int i = 0; i < Eq.size(); i++) {
        ...
        double sT = -22.11 + 808.7*T - 11604.4*T2 + 81700*T3 - 282480*T4 + 384116*T5;
        double vT = -1.6 - 121.7*T + 1775*T2 - 5516*T3;
        double wT = -9.874 + 469*T - 4371.5*T2 + 11000*T3;
        double alphaT = 84.784 - 3028.6*T + 42434*T2 - 291390*T3 + 981000*T4 - 1295400*T5;
